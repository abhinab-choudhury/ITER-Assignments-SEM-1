package DSA_Assignment_6_SEM_2.Lab_Assignment;
/*
...
public class A6Q2 {
  ...
  public static Node pop(Node top) throws StackUnderFlow {
    if (top == null) {
      throw new StackUnderFlow("Cannot use POP operation: Stack is Empty.");
    } else {
      top = top.next;
    }
    return top;
  ...
  public static void peek(Node top) throws EmptyStack {
    if (top == null) {
      throw new EmptyStack("Cannot use PEEK operation: Stack is Empty");
    } else {
